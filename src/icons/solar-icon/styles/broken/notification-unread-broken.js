...
export const NotificationUnreadBroken = (
	<SVG viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="bloom-icon bloom-icon-notification-unread-broken">
		<Path
